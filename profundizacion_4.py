...
- Crear una una variable llamada hijo
  ...
  los apellidos almacenados en apellido_1 y apellido_2
  Imprimir en consola el contenido de esta variable
...
nombre_completo_1= input("Ingrese el nombre completo: ")

print(nombre_completo_1)

nombre_completo_2= input("Ingrese el nombre completo: ")
...
nombre_1= nombre_completo_1.split(" ")
print(nombre_1)

apellido_1= nombre_1[1]

print(apellido_1)

nombre_2= nombre_completo_2.split(" ")
print(nombre_2)

apellido_2= nombre_2[1]
